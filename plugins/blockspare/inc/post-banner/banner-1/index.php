<?php 
    ...
    function blockspare_banner_one_render_block($attributes){
        ...
        <div class='<?php  echo esc_attr($blockuniqueclass);?> align<?php echo esc_attr($alignclass) ?>'>
            <div class='<?php echo esc_attr( $animation_class ) ?> blockspare-banner-wrapper blockspare-banner-1-main-wrapper <?php echo esc_attr($attributes['bannerOneLayout']) ?> <?php echo esc_attr($attributes['blockHoverEffect']) ?>' blockspare-animation=<?php echo esc_attr( $attributes['animation'] )?>>
