...
function blockspare_query_loop_and_wrapper($attributes,$blockclass ='',$design='',$blockName='', $layoutClass=false){
   ...
   $grid_query = blockspare_post_query($attributes);
    if ($grid_query->have_posts()) {
        ...
        $grid_class = $blockuniqueclass . ' blockspare-posts-block-latest-post-wrap '  . $listgridClass . ' ' . $list_layout_class.' '.$animation_class ;
        ...
        <div class="<?php echo esc_attr($class);?>">
            <section class="blockspare-posts-block-post-wrap">
                ...
                if($attributes['enablePagination']=='true' && $grid_query->max_num_pages >1){ ?>
                    <div class="bs_blockspare_loadmore blockspare-readmore-wrapper"  data-layout="<?php echo $layoutClass; ?>" block-name="tile" data-page='2' blockspare-att=<?php echo "'" .  wp_kses_post(wp_json_encode($attributes))."'";?> max-paged="<?php echo $grid_query->max_num_pages;?>">
                        <a href="#" class="blockspare-readmore">
                            <div class="ajax-loader"></div>
                            <span class="load-btn"><?php echo($attributes['loadMoreText']); ?></span>
                        </a>
                    </div><?php 
                }
                ?>
