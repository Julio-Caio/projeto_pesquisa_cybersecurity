        ...
        public function add_block_template_library( $blocks_lists ){
            ...
            $block_library_list = array(
					array(
						...
						'content'  => '<!-- wp:blockspare/blockspare-social-sharing {"custombackgroundColorOption":"#e74c3c","buttonShapes":"blockspare-social-icon-circle","uniqueClass":"blockspare-7ff53d28-7e8e-4"} /-->',
                    ),
                    array(
						'type'     => 'block',
						'item'     => ['Social Sharing'],
						...
						'content'  => '<!-- wp:blockspare/blockspare-social-sharing {"buttonFills":"blockspare-social-icon-border","iconColorOption":"custom","customfontColorOption":"#8e44ad","custombackgroundColorOption":"#8e44ad","buttonShapes":"blockspare-social-icon-rounded","uniqueClass":"blockspare-ab4fc186-9f70-4"} /-->',
                    ),
                    array(
						'type'     => 'block',
						'item'     => ['Social Sharing'],
